...
See the [runtime guide](./docs/ade-runtime.md) and [responsibility boundaries](./docs/ade-responsibilities.md). Python runtime code lives in `ade/`; workflows remain in `skills/` and `prompt/`. npm is used only for changesets.
